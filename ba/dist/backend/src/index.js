...
const resolvers = {
    ...
    Mutation: {
        ...
        spawnKaAgent: async (_parent, args, _context, _info) => {
            ...
            // Prepare command-line arguments for ka
            const kaArgs = ['server'];
            if (name) {
            ...
            // Spawn ka agent with 'server' command and arguments, port is set via environment variable
            const kaProcess = (0, child_process_1.spawn)(kaPath, kaArgs, {
                env,
